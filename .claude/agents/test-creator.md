...
Take a SINGLE, SPECIFIC todo item and create complete, failing tests that define the expected behavior. These tests will guide the coder's implementation.
